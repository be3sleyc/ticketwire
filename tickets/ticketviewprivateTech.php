...
<section>
    <div class="sectionContent">
        ...
        <form action="index.php" method="post">
            ...
            <input type="hidden" name="action" value="techUpdate">
            ...
            <div class="ticketDetails">
                ...
                <div class=technicianSummary>
                    <?php if (isset($ticket['TechnicianName'])) : ?>
                        <input type="hidden" name="technicianID" value="<?=$ticket['TechID']?>">
                    ...
                    <?php else : ?>
                        <label for="technicianName">Technician Name:&nbsp;To Be Assigned</label><br>
                    <?php endif; ?>
                </div>
